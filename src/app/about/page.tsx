...
export default function AboutPage() {
  ...
  return (
    <div>
      <Hero colorWave="#fafafa" subtitle="NUESTRA HISTORIA" title="¿Quienes Somos?" />
      <Card title="¿Quienes Somos ?" description="Somos un Colegio de reconocida trayectoria educativa, que imparte una educación democrática centrada en el desarrollo del ser humano, en el marco del conocimiento y valoración de la cultura peruana." />
      <Card title="Nuestra Historia" description="RESEÑA HISTÓRICA
