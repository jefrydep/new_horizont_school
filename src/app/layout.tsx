...
export const metadata: Metadata = {
  ...
  description: "el mejor colegio de JULIACA",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      >
        <div className="bg-[#fbcc07] rounded-b-2xl px-2 sm:px-4 sm:py-2 w-full ">
          <div className=" flex gap-2 sm:gap-5 container justify-center items-center m-auto">
            ...
            <div className="flex items-center gap-2 ">
              <p className=" font-semibold sm:font-bold text-sm  sm:tracking-widest">50% DE DESCUENTO </p>
              <span className="hidden sm:block " >en inscripción para estudiante nuevos,</span>
