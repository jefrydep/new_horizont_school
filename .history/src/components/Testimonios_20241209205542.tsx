...
const testimonios = [
  ...
  },
  {
    ...
    testimonial: "Los profesores y el ambiente en la institucion NUEVO HORIZONTE fueron clave para mi éxito académico.",
...
export default function Testimonials() {
  return (
    <div className="w-full py-16 bg-gradient-to-r from-white to-primary text-white">
