...
export default function Navbar() {
  ...
  return (
    <div className="border-b sticky shadow   px-4">
      <nav className="container font-bold flex justify-between items-center m-auto">
        ...
        <div>
          <div className="flex flex-col items-center space-y-0.5">
            <div className="w-[84px] absolu h-[85px] bg-red-500"></div>

            <div className="w-0 h-0 border-l-[45px] border-l-transparent border-r-[45px] border-r-transparent border-t-[40px] border-t-red-500"></div>
          </div>
        </div>
