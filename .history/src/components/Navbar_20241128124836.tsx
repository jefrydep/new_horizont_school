        ...
        <Sheet>
          ...
          <SheetContent>
            ...
            <div className=" flex flex-col   gap-6 items-center text-secondary tracking-widest">
              ...
              <Button className="text-white  mr-4 bg-title hover:bg-orange-900 ">
                <a target="_blank" className="flex gap-3 hover:bg-orange-900" href="https://www.peruschool.com.pe/NHJuliaca">
