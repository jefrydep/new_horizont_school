const HighlightStudent = () => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-primary to-white">
      {/* Contenedor principal */}
      <div className="flex flex-col md:flex-row items-center bg-white text-gray-800 rounded-lg shadow-lg overflow-hidden p-8 max-h-64">
