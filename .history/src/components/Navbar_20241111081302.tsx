...
export default function Navbar() {
  ...
  return (
    <div className="border-b sticky shadow  bg-primary  px-4">
      <nav className="container font-bold rounded-t-3xl  border-b-0 bg-white flex justify-between items-center m-auto">
