...
const HighlightStudent = () => {
  return (
    ...
    <div className="flex container m-auto flex-col md:flex-row items-center justify-center bg-gradient-to-r from-blue-500 to-blue-700 text-white rounded-lg shadow-lg overflow-hidden p-8">
