const HighlightStudent = () => {
  return (
    <div className="h-64 flex items-center justify-center bg-gradient-to-r  from-primary to-white">
      ...
      <div className="flex flex-col md:flex-row items-center bg-white text-gray-800 rounded-lg shadow-lg overflow-hidden p-8 ">
        ...
        <div className="md:w-auto flex justify-center mt-8 md:mt-0">
          <img
            src="/ingresante.jpg"
            alt="Estudiante"
            className="w-64  rounded-full border-4 border-primary shadow-lg  "
          />
        </div>
      </div>
    </div>
