      ...
      <nav className="container font-bold flex justify-between items-center m-auto">
        ...
        <div>
          <div className="flex flex-col items-center space-y-0.5">
            <div className="w-0 h-0 border-l-[20px] border-l-transparent border-r-[20px] border-r-transparent border-b-[20px] border-b-red-500"></div>

            <div className="w-[40px] h-[100px] bg-red-500"></div>

            <div className="w-0 h-0 border-l-[20px] border-l-transparent border-r-[20px] border-r-transparent border-t-[20px] border-t-red-500"></div>
          </div>
        </div>
