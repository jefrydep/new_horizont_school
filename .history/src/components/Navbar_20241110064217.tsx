      ...
      <nav className="container font-bold flex justify-between items-center m-auto">
        ...
        <div className="hidden sm:flex gap-6 items-center text-secondary tracking-widest">
          ...
          <NavigationMenu>
            <NavigationMenuList>
              <NavigationMenuItem>
                <NavigationMenuTrigger asChild>Acerca de</NavigationMenuTrigger>
        ...
        <div className="sm:hidden flex items-center">
          <Sheet>
            ...
            <SheetContent>
              <SheetHeader>
                <SheetTitle>Colegio Nuevo Horizonte</SheetTitle>
              ...
              <div className=" flex flex-col font-bold gap-6 items-center text-secondary tracking-widest">
                {navMenu.map((item) => (
                  <Link
                    key={item.id}
                    href={item.path}
