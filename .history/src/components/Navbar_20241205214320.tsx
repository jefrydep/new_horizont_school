...
export default function Navbar() {
  ...
  return (
    <div className="  border  z-50  shadow-sm  w-full  fixed       ">
      <div className=" from-title bg-gradient-to-b from-white from-2% via-white via-50% to-title to-95%   px-2 sm:px-4 sm:py-2 w-full ">
      ...
      <div className="bg-gradient-to-b from-2% via-white via-50% to-title to-95% ">
