const HighlightStudent = () => {
  return (
    <div className="  flex items-center justify-center bg-gradient-to-r from-primary to-white">
      ...
      <div className="flex flex-col md:flex-row items-center bg-white text-gray-800 rounded-lg shadow-lg overflow-hidden p-4">
        ...
        <div className="md:w-auto text-center md:text-left p-4">
          ...
          <h2 className="text-2xl mb-2 text-title font-bold"> Shannen Diana Mamani Justo</h2>
          <p className="text-lg mb-4 font-light text-subtitle">Ha logrado ingresar con éxito a:</p>
          <p className="text-xl font-semibold">Universidad Nacional de San Agustin de Arequipa </p>
        </div>
