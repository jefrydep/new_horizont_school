      ...
      <nav className="container font-bold flex justify-between items-center m-auto">
        ...
        <div>
          <div className="flex flex-col items-center space-y-0.5">
            <div className="w-[84px]   h-[85px] bg-red-500"></div>

            <div className="w-0 h-0 border-l-[42px] border-l-transparent border-r-[24px] border-r-transparent border-t-[40px] border-t-red-500"></div>
          </div>
        </div>
