  ...
  return (
    <div className="border-b sticky shadow py-2 px-4">
      <nav className="container font-bold flex justify-between items-center m-auto">
        ...
        <div>
          {/* <div className="bg-primary  border-l-[20px] border-l-transparent border-r-[20px] border-r-transparent border-t-[40px] border-t-blue-500  absolute top-0 bottom-0  ">sss</div> */}
        </div>
