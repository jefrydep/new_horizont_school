...
export default function Navbar() {
  ...
  return (
    <div className="  border  z-50  shadow-sm  w-full  fixed bg-white       ">
      ...
      <nav className="container font-bold   bg-gradient-to-b from-title from-10% via-white via-50% to-title to-90%   sticky top-8   flex justify-between items-center m-auto">
