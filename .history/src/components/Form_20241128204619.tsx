    ...
    <div className="bg-gray-100  py-8">
      <div className="container pb-8 m-auto sm:w-[720px] shadow-2xl rounded-lg">
        ...
        >
          <Form>
            <div>
              <Field name="dni" placeholder="DNI" className="input"  as={Input} />
              <ErrorMessage
                name="dni"
                component="div"
            ...
            <div>
              <Field as={Input} name="name" placeholder="Nombres" className="input" />
              <ErrorMessage
                name="name"
                component="div"
                className="text-red-500"
            ...
            <div>
              <Field as={Input} name="cellphone" placeholder="Celular" className="input" />
              <ErrorMessage
                name="cellphone"
                component="div"
                className="text-red-500"
